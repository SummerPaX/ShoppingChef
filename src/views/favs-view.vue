...
<template>
	<div class="flex justify-center">
		<div
			class="realtive h-screen flex flex-col max-w-xl md:max-w-[95%] xl:max-w-6xl transition-all duration-200 ease-linear flex-grow overflow-visible scroll-smooth"
		>
			<div class="md:sticky transition-all ease-in-out shadow-lg md:mx-[-0.25rem] rounded-b-lg duration-200 top-0 px-2">
				<h1 class="text-3xl dark:text-white text-center py-4">All your good Stuff</h1>
			</div>
			<div class="mb-[4.25rem] md:mb-0 px-1 scrollbar overflow-y-auto overflow-clip scroll-smooth">
