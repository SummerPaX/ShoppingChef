...
<template>
	<div class="absolute left-4 right-0 flex items-center justify-start flex-col h-screen overflow-auto scrollbar pt-5">
		...
		<div class="hidden md:flex flex-row flex-nowrap m-1 items-start justify-start ">
			<Day class="w-[11vw] lg:w-[12vw] 2xl:w-48 transition-all" @alert="emit('alert')" :day="today.subtract({ days: today.dayOfWeek - 1 })"></Day>
			<Day class="w-[11vw] lg:w-[12vw] 2xl:w-48 transition-all" @alert="emit('alert')" :day="today.subtract({ days: today.dayOfWeek - 2 })"></Day>
			<Day class="w-[11vw] lg:w-[12vw] 2xl:w-48 transition-all" @alert="emit('alert')" :day="today.subtract({ days: today.dayOfWeek - 3 })"></Day>
			<Day class="w-[11vw] lg:w-[12vw] 2xl:w-48 transition-all" @alert="emit('alert')" :day="today.subtract({ days: today.dayOfWeek - 4 })"></Day>
			<Day class="w-[11vw] lg:w-[12vw] 2xl:w-48 transition-all" @alert="emit('alert')" :day="today.subtract({ days: today.dayOfWeek - 5 })"></Day>
			<Day class="w-[11vw] lg:w-[12vw] 2xl:w-48 transition-all" @alert="emit('alert')" :day="today.subtract({ days: today.dayOfWeek - 6 })"></Day>
			<Day class="w-[11vw] lg:w-[12vw] 2xl:w-48 transition-all" @alert="emit('alert')" :day="today.subtract({ days: today.dayOfWeek - 7 })"></Day>
		</div>
