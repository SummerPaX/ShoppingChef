...
const recipe: Recipe = props.recipeProp?.recipe as Recipe;
</script>

<template>
	<div
		class="w-full relative md:max-h-56 mb-2 overflow-hidden transition-all duration-200 md:flex border border-black dark:border-primary-600 rounded-sm shadow-md bg-white dark:bg-neutral-700"
	>
